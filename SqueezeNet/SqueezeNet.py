...
def SqueezeNet_v1_0(H, W, C, num_classes, act, drop_rate=0.25, reg=0):
    ...
    maxpool1 = MaxPooling2D(
        pool_size=[3, 3], strides=[2, 2], name="maxpool1", data_format=data_format
    )(conv1)
    ...
    maxpool4 = MaxPooling2D(
        pool_size=[3, 3], strides=[2, 2], name="maxpool4", data_format=data_format
    )(fire4)
    ...
    maxpool8 = MaxPooling2D(
        pool_size=[3, 3], strides=[2, 2], name="maxpool8", data_format=data_format
    )(fire8)
...
def SqueezeNet_v1_1(H, W, C, num_classes, act, drop_rate=0.25, reg=0):
    ...
    maxpool3 = MaxPooling2D(
        pool_size=[3, 3], strides=[2, 2], name="maxpool3", data_format=data_format
    )(fire3)
    ...
    maxpool5 = MaxPooling2D(
        pool_size=[3, 3], strides=[2, 2], name="maxpool5", data_format=data_format
    )(fire5)
